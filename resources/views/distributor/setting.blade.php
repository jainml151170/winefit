    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('distributor.update.setting') }}">
                        @csrf
                        @method('POST')
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email"
                                    class="form-control @error('email') is-invalid @enderror" value="{{ $email }}"  disabled>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="user_phone" type="tel"
                                    ...
                                    value="{{ $phone }}" required autocomplete="user_phone" autofocus>
